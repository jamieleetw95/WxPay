...
namespace WxPayAPI
{
    public class NativePay
    {
        ...
        * @return 模式二URL
        */
        public string GetPayUrl(string productId,string orderId)
        {
            ...
            data.SetValue("out_trade_no", orderId);//商户订单号(随机字符串)
            data.SetValue("total_fee", 101);//沙箱支付金额只能是 1.01 和 1.02
