...
namespace WxPayAPI
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData OrderQuery( WxPayData inputObj, int timeOut = 60 )
        {
        ...
        */
        public static WxPayData Reverse( WxPayData inputObj, int timeOut = 60 )
        {
        ...
        */
        public static WxPayData Refund( WxPayData inputObj, int timeOut = 60 )
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData RefundQuery( WxPayData inputObj, int timeOut = 60 )
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData ShortUrl( WxPayData inputObj, int timeOut = 60 )
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData CloseOrder( WxPayData inputObj, int timeOut = 60 )
        {
	    ...
	    */
        public static WxPayData Report( WxPayData inputObj, int timeOut = 1 )
        {
            ...
            inputObj.SetValue("nonce_str", GenerateNonceStr());//随机字符串
            inputObj.SetValue("sign_type", WxPayData.SIGN_TYPE_HMAC_SHA256);//签名类型
            inputObj.SetValue("sign", inputObj.MakeSign(WxPayData.SIGN_TYPE_HMAC_SHA256, GetSandboxSignkey()));//签名
            string xml = inputObj.ToXml();
        ...
        * SandboxSignKey
        */
        public static WxPayData GetSandboxSignKey( int timeOut = 36 )
        {
            ...
            Log.Debug("WxPayApi", "GetSandboxSignKey request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            Log.Debug("WxPayApi", "GetSandboxSignKey response : " + response);
        ...
        */
        ...
        {
            WxPayData result = WxPayApi.GetSandboxSignKey();//调用统一下单接口
            string sandbox_signkey = result.GetValue("sandbox_signkey").ToString();//获得统一下单接口返回的二维码链接
